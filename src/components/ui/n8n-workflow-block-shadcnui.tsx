    ...
    <div className="w-full">
      ...
      <div className="mb-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-lg font-bold tracking-tight">Workflow Builder</h2>
        </div>
        <Button
          variant="outline"
          size="sm"
              ...
              >
                <Card
                  className={`group/node relative w-full overflow-hidden rounded-xl border ${
                    colorClasses[node.color] || colorClasses.blue
                ...
                >
                  ...
                  <div className="mt-2 flex items-center justify-between border-t border-border/20 pt-2 text-[9px] text-muted-foreground">
                    <span className="flex items-center gap-1">
                      <span className="h-1.5 w-1.5 rounded-full bg-emerald-500" />
                      Connected
                    </span>
                    <ArrowRight className="h-3 w-3 opacity-40 group-hover/node:opacity-100 transition-opacity" />
                  </div>
                </Card>
              </motion.div>
            );
