...
export const LevelUpModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-[2px] p-4">
      <div className="bg-[#FFFFFF] border border-[#E2E8F0] rounded-[12px] max-w-md w-full p-6 text-center shadow-2xl relative animate-in zoom-in-95 duration-200">
        ...
        <div className="mt-6 flex items-center gap-3">
          <button
            ...
            className="flex-1 px-4 py-2.5 text-[12px] font-medium border border-[#E2E8F0] bg-[#FFFFFF] hover:bg-[#F4F4F5] rounded-[6px] text-[#18181B] transition-colors"
          >
            Celebrate 🎉
          </button>
          <button
            onClick={closeLevelUpModal}
            className="flex-1 px-4 py-2.5 text-[12px] font-bold bg-[#18181B] hover:bg-[#27272A] text-white rounded-[6px] transition-colors flex items-center justify-center gap-1.5"
          >
